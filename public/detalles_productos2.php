    ...
    <body class="purple lighten-5">
      ...
      <div class="row">
        ...
        <div class="col s12 m6 l6">
          <div id="este-st" class="slider">
            <ul class="slides materialboxed">
              <li>
                <img src="img/descripcion_product/21.png">
                <div class="caption center-align">
                </div>
              </li>
              <li>
                <img src="img/descripcion_product/22.png">
        ...
        <div class="col s12 m6 l6">
            ...
            <li class="divider"></li>
            <div>
                <a href="metodo_compra.php" class="waves-effect waves-light btn"><i class="material-icons right">add_shopping_cart</i>Agregar a carretilla</a>
            </div>
        </div>
        ...
        <ul class="collapsible popout" data-collapsible="accordion">
            <li>
                ...
                <div class="collapsible-body"><p>Audifonos marca sony.</p></div>
            </li>
            <li>
                <div class="collapsible-header">Especificaciones</div>
                <div class="collapsible-body">
                    <p>Color: negro+rojo.</p>
                    <p>Capacidad: 100dB.</p>
                    <p>Corriente y voltaje: 1A, 5V.</p>
                    <p>Compatible con: PC, android, iphone, ipod, ipad.</p>
                    </div>
            </li>
            <li>
                <div class="collapsible-header">Dimensiones</div>
                <div class="collapsible-body"><p>Dimensiones: 15cm x 12cm x 5cm.</p></div>
            </li>
         </ul>
             ...
             <h3>Comentarios:</h3>
               <ul class="collection">
                    ...
                    <li class="collection-item avatar">
                        ...
                        <a href="#!" class="secondary-content"><i class="material-icons">grade</i><i class="material-icons">grade</i><i class="material-icons">grade</i></a>
                    </li>
                    <li class="collection-item avatar">
                        <i class="material-icons circle blue">person</i> 
