  ...
  <html>
    ...
    <?php include("../inc/menu2.php");?>
      ...
      <div id="contenedor" class="container white z-depth-5">  
          <h2 class="center-align">Registros de sucursales</h2>
           <form  action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
               ...
               <a class="btn waves-effect waves-light btn-large red col s2 s12 m4 l2 offset-m1 offset-l1" href="http://localhost/ecomerce/admin/create_sucursal.php">
			    	          Nuevo registro<i id="img_btn" class="material-icons left md-36"></i>
			         </a>
               </div>
               <?php
               include 'scrud/read_sucursal.php' 
               ?>
           </form>     
      </div>
