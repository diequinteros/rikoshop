				...
				<nav>
					<div class='nav-wrapper blue darken-1'>
						...
						<ul class='right hide-on-med-and-down'>
							<li><a href='http://localhost/Rikoshop/public/index.php'><i class='material-icons left'>home</i>Inicio</a></li>
							<li><a href='http://localhost/Rikoshop/public/menucat.php'><i class='material-icons left'>local_grocery_store</i>Categorías</a></li>
							<li><a href='http://localhost/Rikoshop/public/registro.php'><i class='material-icons left'>group_add</i>Registrate</a></li>
							<li><a href='http://localhost/Rikoshop/public/login.php'><i class='material-icons left'>account_circle</i>Iniciar Sesion</a></li>
						</ul>
						<ul class='side-nav' id='mobile-demo'>
							<li><a href='http://localhost/Rikoshop/public/index.php'><i class='material-icons left'>home</i>Inicio</a></li>
							<li><a href='http://localhost/Rikoshop/public/menucat.php'><i class='material-icons left'>local_grocery_store</i>Categorías</a></li>
