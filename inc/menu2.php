		...
		$menu .= "<div class='navbar-fixed'>
				<nav>
					<div class='nav-wrapper blue darken-1'>
						<a id='Logo' href='https://localhost/Rikoshop/admin/index.php' class='brand-logo'>( ͡° ͜ʖ ͡°)</a>
						<a href='#' data-activates='mobile-demo' class='button-collapse'><i class='material-icons'>menu</i></a>
						<ul class='right hide-on-med-and-down'>
							<li><a href='https://localhost/Rikoshop/admin/index.php'><i class='material-icons left'>home</i>Inicio</a></li>
							<li><a href='https://localhost/Rikoshop/public/profile.php'><i class='material-icons left'>account_circle</i>".$_SESSION['nombre_usuario']."</a></li>
							<li><a href='https://localhost/Rikoshop/public/logout.php'><i class='material-icons left'>power_settings_new</i>Cerrar Sesion</a></li>
						</ul>
